...
export const experiencesData = [
  {
    ...
    location: "Infobip",
    description:
      "Infobip is an omni-channel communications platform for customer support and engagement, which uses SMS, voice messages, email, and mobile app messaging",
    icon: React.createElement(CgWorkAlt),
    date: "March 2016 - January 2019",
  },
  {
  ...
  },
  {
    ...
    location: "Quality IT",
    description:
      "Quality IT is a leading provider of innovative IT solutions, specializing in cloud computing, software development, and digital transformation services",
    icon: React.createElement(CgWorkAlt),
